...
$qryCreateTable .="fechanoticia DATE DEFAULT CURRENT_DATE, creador VARCHAR(255) DEFAULT NULL, fechacreacion DATE DEFAULT CURRENT_DATE,";
$qryCreateTable .="modificador VARCHAR(255) DEFAULT NULL, fechamodificacion DATE DEFAULT CURRENT_DATE, keywordsnoticia VARCHAR(255) DEFAULT NULL,";
