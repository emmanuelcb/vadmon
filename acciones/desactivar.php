...
if (!isset($_COOKIE['loggedin'])) {
	...
	if($edicionseleccionada=="contenidos"){
		...
		header("Location: ../inicio.php?idcontenido=contenidos&mensaje=desactivarContenido");
	}
	...
	if($edicionseleccionada=="promociones"){
		...
		header("Location: ../inicio.php?idcontenido=promociones&mensaje=desactivarContenido");
	}
	...
	// Si lo que deseamos editar es un banner
		...
		header("Location: ../inicio.php?idcontenido=banners&mensaje=desactivarBanner");
	}
	...
	// Si lo que deseamos editar es un artículo
		...
		header("Location: ../inicio.php?idcontenido=articulos&mensaje=desactivarArticulo");
	}
	...
	// Si lo que deseamos es editar una noticia
		...
		header("Location: ../inicio.php?idcontenido=noticias&mensaje=desactivarNoticia");
	}
	...
	// Si lo que deseamos es editar una configuracion
		...
		header("Location: ../inicio.php?idcontenido=configuracion&mensaje=desactivarConfiguracion");
	}
